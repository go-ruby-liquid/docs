...
The public API lives at the module root (`github.com/go-ruby-liquid/liquid`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `liquid`, while the surface follows
...
```go
import "github.com/go-ruby-liquid/liquid"
```
...
- **[pkg.go.dev/github.com/go-ruby-liquid/liquid](https://pkg.go.dev/github.com/go-ruby-liquid/liquid)**

The module's [README](https://github.com/go-ruby-liquid/liquid#readme) carries worked
