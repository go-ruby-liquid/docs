# go-ruby-liquid documentation

**Pure-Go, MRI-faithful Ruby liquid (no cgo)**

`go-ruby-liquid/liquid` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `liquid`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `liquid`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`liquid`](https://github.com/go-ruby-liquid/liquid) | the library — Ruby's `liquid` in pure Go |
| [`docs`](https://github.com/go-ruby-liquid/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-liquid.github.io`](https://github.com/go-ruby-liquid/go-ruby-liquid.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-liquid/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-liquid/liquid](https://github.com/go-ruby-liquid/liquid).
