...
`go-ruby-liquid/liquid` reimplements Ruby's `liquid` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-liquid/liquid` directly, with no Ruby runtime;
